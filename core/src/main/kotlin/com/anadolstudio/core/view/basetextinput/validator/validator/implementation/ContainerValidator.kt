...
import com.anadolstudio.core.view.basetextinput.validator.validator.BaseValidator
    ...
    override fun validate(text: String): ValidateResult {
        ...
        val validateResult: ValidateResult = run breaking@{
            validatorUnits.forEach { unit ->
                when (unit) {
                    is com.anadolstudio.core.view.basetextinput.validator.mapper.ValidateMapper -> currentText = unit.map(currentText)
